...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="9">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='9')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:9'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "9"
```

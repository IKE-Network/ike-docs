...
```
<dependency org="network.ike.docs" name="minimal-fonts" rev="9">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='minimal-fonts', version='9')
)
```
...
```
implementation 'network.ike.docs:minimal-fonts:9'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "minimal-fonts" % "9"
```

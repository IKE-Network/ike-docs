...
Documentation plumbing: ike-doc-maven-plugin (the extensions=true provider of ike-doc packaging), koncept-asciidoc-extension, minimal-fonts, docbook-xsl, ike-doc-resources, semantic-linebreak.
...
See `CLAUDE-ike-docs.md` for project-specific notes.

...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="79">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='79')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:79'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "79"
```

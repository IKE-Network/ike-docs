...
Licenses for declared dependencies of `semantic-linebreak` 75-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
...
Reference: [EPL-2.0 on spdx.org](https://spdx.org/licenses/EPL-2.0.html)[7]

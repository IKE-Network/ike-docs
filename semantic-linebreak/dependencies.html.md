...
Full transitive dependency graph for `semantic-linebreak` 50-SNAPSHOT, generated from [bom.json](bom.json)[1] (CycloneDX 1.6) at build time. Same SBOM source as the SPDX-grouped [licenses.html](licenses.html)[2] and the curated [built-with.html](built-with.html)[3] — three views of the same data.

## [#summary](#summary)Summary

| Total components | 43 |
| --- | --- |
| Distinct license expressions | 10 |
...
| `org.apache.maven.plugin-tools` | `maven-plugin-annotations` | `3.15.1` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj` | `3.0.1` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj-api` | `3.0.1` | `Apache-2.0` | library |
| `org.codehaus.plexus` | `plexus-classworlds` | `2.8.0` | `Apache-2.0` | library |
| `org.codehaus.plexus` | `plexus-component-annotations` | `2.1.0` | `Apache-2.0` | library |
| `org.codehaus.plexus` | `plexus-utils` | `3.5.1` | `Apache-2.0` | library |
| `org.codehaus.plexus` | `plexus-xml` | `3.0.1` | `Apache-2.0` | library |
| `org.crac` | `crac` | `1.5.0` | `BSD-2-Clause` | library |
| `org.eclipse.sisu` | `org.eclipse.sisu.inject` | `0.9.0.M3` | `EPL-2.0` | library |
| `org.eclipse.sisu` | `org.eclipse.sisu.plexus` | `0.9.0.M3` | `EPL-2.0` | library |
...
- As a Maven artifact: pull `semantic-linebreak:​50-SNAPSHOT` with `<classifier>cyclonedx</classifier><type>json</type>` from Nexus / Maven Central.

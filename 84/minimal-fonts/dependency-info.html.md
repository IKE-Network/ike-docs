...
```
<dependency org="network.ike.docs" name="minimal-fonts" rev="84">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='minimal-fonts', version='84')
)
```
...
```
implementation 'network.ike.docs:minimal-fonts:84'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "minimal-fonts" % "84"
```

## [Leiningen](#leiningen)

```
[network.ike.docs/minimal-fonts "84"]
```

...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="80">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='80')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:80'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "80"
```

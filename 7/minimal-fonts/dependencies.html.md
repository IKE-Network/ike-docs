...
| --- | --- | --- | --- | --- | --- |
| network.ike.tooling | [ike-build-standards](https://ike.network/ike-tooling/ike-build-standards/)[1] | 146 | claude | zip | [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
...
- network.ike.docs:minimal-fonts:pom:7 ** 
  
  | IKE Minimal Fonts |
  | --- |
  | **Description: **Minimal Noto font subset for IKE documentation (~4MB) **URL: **[https://github.com/IKE-Network/ike-minimal-fonts](https://github.com/IKE-Network/ike-minimal-fonts)[3] **Project Licenses: **[SIL Open Font License 1.1](https://scripts.sil.org/OFL)[4] |
...
**Apache License, Version 2.0: **IKE Build Standards

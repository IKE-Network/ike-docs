...
```
<dependency org="network.ike.docs" name="minimal-fonts" rev="30">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='minimal-fonts', version='30')
)
```
...
```
implementation 'network.ike.docs:minimal-fonts:30'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "minimal-fonts" % "30"
```

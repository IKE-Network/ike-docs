...
```
<dependency org="network.ike.docs" name="minimal-fonts" rev="29">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='minimal-fonts', version='29')
)
```
...
```
implementation 'network.ike.docs:minimal-fonts:29'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "minimal-fonts" % "29"
```

...
Full transitive dependency graph for `ike-doc-maven-plugin` 89-SNAPSHOT, generated from [bom.json](bom.json)[1] (CycloneDX 1.6) at build time. Same SBOM source as the SPDX-grouped [licenses.html](licenses.html)[2] and the curated [built-with.html](built-with.html)[3] — three views of the same data.
...
| `com.googlecode.javaewah` | `JavaEWAH` | `1.2.3` | `Apache-2.0` | library |
...
| `com.sparrowwallet` | `toucan` | `0.9.0` | `Apache-2.0` | library |
| `commons-codec` | `commons-codec` | `1.17.1` | `Apache-2.0` | library |
| `io.github.java-diff-utils` | `java-diff-utils` | `4.12` | `Apache-2.0` | library |
...
| `network.ike.docs` | `ike-doc-resources` | `89-SNAPSHOT` | `Apache-2.0` | library |
| `network.ike.docs` | `koncept-asciidoc-extension` | `89-SNAPSHOT` | `Apache-2.0` | library |
| `network.ike.docs` | `koncept-core` | `89-SNAPSHOT` | `Apache-2.0` | library |
...
| `org.asciidoctor` | `asciidoctorj-diagram` | `2.3.1` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj-diagram-batik` | `1.17` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj-diagram-ditaamini` | `1.0.3` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj-diagram-plantuml` | `1.2024.5` | `Apache-2.0` | library |
| `org.asciidoctor` | `asciidoctorj-pdf` | `2.3.23` | `Apache-2.0` | library |
| `org.crac` | `crac` | `1.5.0` | `BSD-2-Clause` | library |
| `org.eclipse.jgit` | `org.eclipse.jgit` | `7.1.0.202411261347-r` | `BSD-3-Clause` | library |
...
| `org.slf4j` | `slf4j-api` | `1.7.36` | `MIT` | library |
| `org.yaml` | `snakeyaml` | `2.3` | `Apache-2.0` | library |
...
- As a Maven artifact: pull `ike-doc-maven-plugin:​89-SNAPSHOT` with `<classifier>cyclonedx</classifier><type>json</type>` from Nexus / Maven Central.

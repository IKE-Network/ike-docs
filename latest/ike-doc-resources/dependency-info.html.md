...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="10">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='10')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:10'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "10"
```

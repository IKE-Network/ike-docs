...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="11">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='11')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:11'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "11"
```

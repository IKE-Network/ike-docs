...
```
<dependency org="network.ike.docs" name="ike-doc-resources" rev="94">
...
```
@Grapes(
@Grab(group='network.ike.docs', module='ike-doc-resources', version='94')
)
```
...
```
implementation 'network.ike.docs:ike-doc-resources:94'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.docs" % "ike-doc-resources" % "94"
```
